...
{"0": {
    ...
    "content": "NOTE: The blank examples published in this repository are intended for engineering display bring-up only. For feature-rich, professional Microchip Graphics Suite demonstrations and demonstrations from third-party graphics libaries, refer to user guides on Microchip Developer Help or browse on MPLAB® Discover. ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/readme.html",
    "relUrl": "/apps/readme.html"
  },"2": {
    "doc": "Example Applications",
    "title": "Blank Examples",
    "content": ". | Blank Quickstart | . This demonstration provides a touch-enabled test pattern to validate the graphics subsystem. ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/readme.html#blank-examples",
    "relUrl": "/apps/readme.html#blank-examples"
  },"3": {
    "doc": "Blank Quickstart",
    "title": "Blank Quickstart",
    "content": "NOTE: The blank examples published in this repository are intended for engineering display bring-up only. For feature-rich, professional Microchip Graphics Suite demonstrations and demonstrations from third-party graphics libaries, refer to user guides on Microchip Developer Help or browse on MPLAB® Discover. This demonstration provides a touch-enabled test pattern to validate the graphics subsystem. | MPLABX Configuration | Board Configuration | . | blank_qs_9x75_cu_ac69t88a.X | SAM9X75 Curiosity Development Board using XLCDC internal graphics controller to drive the AC69T88A LVDS WVGA Display | . | blank_qs_9x75_cu_raspi_7inch.X | SAM9X75 Curiosity Development Board using XLCDC internal graphics controller to drive the Raspberry Pi Touch Display MIPI DSI Display | . ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/blank_quickstart/readme.html",
    "relUrl": "/apps/blank_quickstart/readme.html"
  },"4": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "![Microchip Graphics Suite](https://mchpgfx.github.io/legato.docs/docs/legato/images/mgs.svg) Microchip Graphics Suite Harmony Application Examples for SAM 9x7 Family ## Microchip Graphics Suite Harmony Application Examples for SAM 9x7 Family v3.2.0 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications |:-----------------|:-------------------:| [SAM 9x75 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV31H43A) | 2 | **NOTE:** The blank examples published in this repository are intended for engineering display bring-up only. For feature-rich, professional Microchip Graphics Suite demonstrations and demonstrations from third-party graphics libaries, refer to user guides on [Microchip Developer Help](https://developerhelp.microchip.com/xwiki/bin/view/software-tools/mgs/dev-kits/sam9x75-ug/) or browse on [MPLAB® Discover](https://mplab-discover.microchip.com/v2?dsl=Microchip+AND+Graphics+AND+Suite+AND+9x7). ## Release v3.2.0 ### New Features New features added in this release are as follows: - Added Blank Quickstart WVGA configuration for the [Raspberry Pi Touch Display](https://www.raspberrypi.com/products/raspberry-pi-touch-display/) MIPI DSI Display - Added Blank Quickstart WVGA configuration for the [AC69T88A LVDS WVGA Display](https://www.microchipdirect.com/dev-tools/AC69T88A?allDevTools=true) ### Known Issues - No Known Issues ### Development Tools - [MPLAB® X IDE v6.20](https://www.microchip.com/mplab/mplab-x-ide) - [MPLAB® XC32 C/C++ Compiler v4.35](https://www.microchip.com/mplab/compilers) - MPLAB® X IDE plug-ins: - MPLAB® Code Configurator (MCC) Plugin v5.5.1 ### Dependent Components * [GFX v3.15.2](https://github.com/Microchip-MPLAB-Harmony/gfx/releases/tag/v3.15.2) ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/release_notes.html",
    "relUrl": "/release_notes.html"
  },"5": {
    "doc": "Microchip Graphics Suite Harmony SAM 9x7 Applications Package",
    "title": "Microchip Graphics Suite Harmony SAM 9x7 Applications Package",
    "content": "# ![Microchip Graphics Suite](https://mchpgfx.github.io/legato.docs/docs/legato/images/mgs.svg) Microchip Graphics Suite Harmony Application Examples for for SAM 9x7 Family Microchip Graphics Suite Harmony is an extension of the MPLAB® ecosystem for creating embedded graphics firmware solutions for Microchip 32-bit SAM and PIC microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB® X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [User Guide for Advanced Graphics Demonstrations](https://developerhelp.microchip.com/xwiki/bin/view/software-tools/mgs/dev-kits/sam9x75-ug/) - [Browse SAM9x7 Demonstrations on MPLAB® Discover](https://mplab-discover.microchip.com/v2?dsl=Microchip+AND+Graphics+AND+Suite+AND+9x7) This repository contains the graphics examples for SAM 9x7 Family for engineering display bring-up. For feature-rich, professional Microchip Graphics Suite demonstrations and demonstrations from third-party graphics libaries, refer to user guides on [Microchip Developer Help](https://developerhelp.microchip.com/xwiki/bin/view/software-tools/mgs/dev-kits/sam9x75-ug/) or browse on [MPLAB® Discover](https://mplab-discover.microchip.com/v2?dsl=Microchip+AND+Graphics+AND+Suite+AND+9x7). Refer to the following links for release notes, home page, training materials, framework and application help. For more information on the tools, libraries and basic development with the MPLAB® Harmony Graphics Suite, please see the gfx repo also on github. - [Release Notes](/gfx_apps_sam_9x7/release_notes.html) - [MPLAB® Harmony License](/gfx_apps_sam_9x7/mplab_harmony_license.html) - [User Guides on Microchip Graphics Suite Harmony](https://developerhelp.microchip.com/xwiki/bin/view/software-tools/mgs/mgs-harmony-guide/) - [Information on Microchip Graphics Suite Development Kits](https://developerhelp.microchip.com/xwiki/bin/view/software-tools/mgs/dev-kits/) - [Discover the Ease of Designing a GUI on a Round Display](https://youtu.be/2cZQuTGj9Ac?si=uu0rVdrviRSJPBaD) # Contents Summary | Folder | Description | ------ | --------------------------------------- | apps | Example Graphics applications | docs | Contains files supporting documentation | Documentation specific for this repository is available for offline viewing. It can be used only after cloning this repository onto a local machine. ## Graphics application examples The following applications are provided to assist in engineering display bring-up. **NOTE:** For feature-rich, professional Microchip Graphics Suite demonstrations and demonstrations from third-party graphics libaries, refer to user guides on [Microchip Developer Help](https://developerhelp.microchip.com/xwiki/bin/view/software-tools/mgs/dev-kits/sam9x75-ug/) or browse on [MPLAB® Discover](https://mplab-discover.microchip.com/v2?dsl=Microchip+AND+Graphics+AND+Suite+AND+9x7). | Category | Item | Description | Release Type | -------- | ----------------------------------------------------------------- | --------------------------------------------- | ------------------------------------------------------------------------------- | apps | [blank_quickstart](/gfx_apps_sam_9x7/apps/blank_quickstart/readme.html) | Blank Quickstart Example | ![app-beta](https://img.shields.io/badge/application-production-green?style=plastic) | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_sam_9x7/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/mchpgfx/legato.docs.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx/tree/v3.12.0) [![Latest release date](https://img.shields.io/github/release-date/mchpgfx/legato.docs.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx/tree/v3.12.0) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/gfx_apps_sam_9x7.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_sam_9x7/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/gfx_apps_sam_9x7.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() ",
...
var home_index_string = "Microchip Graphics Suite Harmony SAM9x7 Applications";
