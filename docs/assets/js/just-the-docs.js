...
{"0": {
    ...
    "content": ". This demonstration provides a touch-enabled starting point for the legato graphics library. | MPLABX Configuration | Board Configuration | . | legato_qs_9x75_eb_ac69t88a.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the AC69T88A LVDS WVGA Display Note: Please contact your local Microchip Sales Office for access to the LVDS adapter and LVDS display. | . | legato_qs_9x75_eb_rpi_7inch.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Raspberry Pi Touch Display MIPI DSI Display | . | legato_qs_9x75_eb_ws_7_9inch.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Waveshare 7.9inch DSI LCD Display | . ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/legato_quickstart/readme.html",
    "relUrl": "/apps/legato_quickstart/readme.html"
  },"4": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "![MPLAB® Harmony Graphics Suite](/gfx_apps_sam_9x7/images/mhgs.png) Microchip MPLAB® Harmony 3 Graphics Application Examples for SAM 9x7 Family # Microchip MPLAB® Harmony 3 Release Notes ## MPLAB® Harmony 3 Graphics Application Examples for SAM 9x7 Family v3.0.0 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications |:-----------------|:-------------------:| [SAM 9x75 Early Access Evaluation Board](https://www.microchip.com/en-us/development-tool/EA14J50A) | 3 | ## Release v3.0.0 ### New Features New features added in this release are as follows: - Added Legato Quickstart WVGA configuration for the [Raspberry Pi Touch Display](https://www.raspberrypi.com/products/raspberry-pi-touch-display/) MIPI DSI Display - Added Legato Quickstart WVGA configuration for the [AC69T88A LVDS WVGA Display](https://www.microchip.com/en-us/about/global-sales-and-distribution) **Note:** Please contact your local [Microchip Sales Office](https://www.microchip.com/en-us/about/global-sales-and-distribution) for access to the LVDS adapter and LVDS display. - Added Legato Quickstart 1280x400 configuration for the [Waveshare 7.9inch DSI LCD](https://www.waveshare.com/7.9inch-dsi-lcd.htm) Display ### Known Issues - No Known Issues ### Development Tools - [MPLAB® X IDE v6.10](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - [MPLAB® Code Configurator (MCC) Plugin v5.3.7](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® Code Configurator (MCC) Core v5.5.7](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® XC32 C/C++ Compiler v4.30](https://www.microchip.com/mplab/compilers) ### Dependent Components * [GFX v3.13.0](https://github.com/Microchip-MPLAB-Harmony/gfx/releases/tag/v3.13.0) ",
...
var home_index_string = "SAM9x7 Graphics Applications";
