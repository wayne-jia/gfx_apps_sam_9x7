...
{"0": {
    ...
    "url": "http://localhost:4000/gfx_apps_sam_9x7/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "Legato Washing Machine",
    "title": "Legato Washing Machine",
    "content": ". A washing machine UI with interactive controls is visulaized using the legato graphics library in this demonstration. | MPLABX Configuration | Board Configuration | . | legato_wm_9x75_eb_ac69t88a.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the AC69T88A LVDS WVGA Display Note: Please contact your local Microchip Sales Office for access to the LVDS adapter. | . | legato_wm_9x75_eb_rpi_7inch.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Raspberry Pi Touch Display MIPI DSI Display | . ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/legato_washing_machine/readme.html",
    "relUrl": "/apps/legato_washing_machine/readme.html"
  },"2": {
    "doc": "LVGL Showcase",
    "title": "LVGL Showcase",
    "content": ". This application demonstrates a simple way to create a graphics application using the LVGL graphics library that directly uses the LCD controller driver. | MPLABX Configuration | Board Configuration | . | lvgl_sc_9x75_eb_ac69t88a.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the AC69T88A LVDS WVGA Display Note: Please contact your local Microchip Sales Office for access to the LVDS adapter. | . | lvgl_sc_9x75_eb_rpi_7inch.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Raspberry Pi Touch Display MIPI DSI Display | . ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/lvgl_showcase/readme.html",
    "relUrl": "/apps/lvgl_showcase/readme.html"
  },"3": {
    "doc": "Example Applications",
    "title": "Example Applications",
    "content": " ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/readme.html",
    "relUrl": "/apps/readme.html"
  },"4": {
    "doc": "Example Applications",
    "title": "Legato Library Examples",
    "content": ". | Legato Quickstart | . This demonstration provides a touch-enabled starting point for the legato graphics library. | Legato Adventure | . This demonstration presents a minimalistic game interface utilizing parallax scrolling effect and sprite animations. | Legato Washing Machine | . A washing machine UI with interactive controls is visulaized using legato graphics library in this demonstration. ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/readme.html#legato-library-examples",
    "relUrl": "/apps/readme.html#legato-library-examples"
  },"5": {
    "doc": "Example Applications",
    "title": "LVGL Library Examples",
    "content": ". | LVGL Showcase | . This application demonstrates a simple way to create a graphics application using the LVGL graphics library that directly uses the LCD controller driver. ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/readme.html#lvgl-library-examples",
    "relUrl": "/apps/readme.html#lvgl-library-examples"
  },"6": {
    "doc": "Legato Quickstart",
    "title": "Legato Quickstart",
    "content": ". This demonstration provides a touch-enabled starting point for the legato graphics library. | MPLABX Configuration | Board Configuration | . | legato_qs_9x75_eb_ac69t88a.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the AC69T88A LVDS WVGA Display Note: Please contact your local Microchip Sales Office for access to the LVDS adapter. | . | legato_qs_9x75_eb_rpi_7inch.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Raspberry Pi Touch Display MIPI DSI Display | . | legato_qs_9x75_eb_ws_7_9inch.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Waveshare 7.9inch DSI LCD Display | . | legato_qs_9x75_eb_ws_2_8inch.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Waveshare 2.8inch DSI LCD Display | . | legato_qs_9x75_eb_ws_4inch_round.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Waveshare 4inch round DSI LCD Display | . | legato_qs_9x75_eb_ws_4inch.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Waveshare 4inch DSI LCD Display | . ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/legato_quickstart/readme.html",
    "relUrl": "/apps/legato_quickstart/readme.html"
  },"7": {
    "doc": "Legato Adventure",
    "title": "Legato Adventure",
    "content": ". This demonstration presents a minimalistic game interface utilizing parallax scrolling effect and sprite animations. | MPLABX Configuration | Board Configuration | . | legato_canvas_adv_9x75_eb_ac69t88a.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the AC69T88A LVDS WVGA Display Note: Please contact your local Microchip Sales Office for access to the LVDS adapter. | . | legato_canvas_adv_9x75_eb_ac69t88a_rtos.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the AC69T88A LVDS WVGA Display Note: Please contact your local Microchip Sales Office for access to the LVDS adapter. | . | legato_adventure_9x75_eb_rpi_7inch.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Raspberry Pi Touch Display MIPI DSI Display | . | legato_adventure_9x75_eb_rpi_7inch_rtos.X | SAM9X75-DDR3-EB Early Access Evaluation Board using XLCDC internal graphics controller to drive the Raspberry Pi Touch Display MIPI DSI Display | . ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/apps/legato_adventure/readme.html",
    "relUrl": "/apps/legato_adventure/readme.html"
  },"8": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "![MPLAB® Harmony Graphics Suite](/gfx_apps_sam_9x7/images/mhgs.png) Microchip MPLAB® Harmony 3 Graphics Application Examples for SAM 9x7 Family # Microchip MPLAB® Harmony 3 Release Notes ## MPLAB® Harmony 3 Graphics Application Examples for SAM 9x7 Family v3.1.0 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications |:-----------------|:-------------------:| [SAM 9x75 Early Access Evaluation Board](https://www.microchip.com/en-us/development-tool/EA14J50A) | 13 | ## Release v3.1.0 ### New Features New features added in this release are as follows: - Added Legato Quickstart 480x640 configuration for the [Waveshare 2.8inch DSI LCD](https://www.waveshare.com/2.8inch-dsi-lcd.htm) MIPI DSI Display - Added Legato Quickstart 720x720 configuration for the [Waveshare 4inch round DSI LCD](https://www.waveshare.com/4inch-dsi-lcd-c.htm) MIPI DSI Display - Added Legato Quickstart 480x800 configuration for the [Waveshare 4inch DSI LCD](https://www.waveshare.com/4inch-dsi-lcd.htm) MIPI DSI Display - Added Legato Adventure WVGA configuration for the [Raspberry Pi Touch Display](https://www.raspberrypi.com/products/raspberry-pi-touch-display/) MIPI DSI Display - Added Legato Adventure WVGA configuration for the [AC69T88A LVDS WVGA Display](https://www.microchipdirect.com/dev-tools/AC69T88A?allDevTools=true) **Note:** Please contact your local [Microchip Sales Office](https://www.microchip.com/en-us/about/global-sales-and-distribution) for access to the LVDS adapter. - Added Legato Adventure WVGA FreeRTOS configuration for the [Raspberry Pi Touch Display](https://www.raspberrypi.com/products/raspberry-pi-touch-display/) MIPI DSI Display - Added Legato Adventure WVGA FreeRTOS configuration for the [AC69T88A LVDS WVGA Display](https://www.microchipdirect.com/dev-tools/AC69T88A?allDevTools=true) **Note:** Please contact your local [Microchip Sales Office](https://www.microchip.com/en-us/about/global-sales-and-distribution) for access to the LVDS adapter. - Added Legato Washing Machine WVGA configuration for the [Raspberry Pi Touch Display](https://www.raspberrypi.com/products/raspberry-pi-touch-display/) MIPI DSI Display - Added Legato Washing Machine WVGA configuration for the [AC69T88A LVDS WVGA Display](https://www.microchipdirect.com/dev-tools/AC69T88A?allDevTools=true) **Note:** Please contact your local [Microchip Sales Office](https://www.microchip.com/en-us/about/global-sales-and-distribution) for access to the LVDS adapter. - Added LVGL Showcase WVGA configuration for the [Raspberry Pi Touch Display](https://www.raspberrypi.com/products/raspberry-pi-touch-display/) MIPI DSI Display - Added LVGL Showcase WVGA configuration for the [AC69T88A LVDS WVGA Display](https://www.microchipdirect.com/dev-tools/AC69T88A?allDevTools=true) **Note:** Please contact your local [Microchip Sales Office](https://www.microchip.com/en-us/about/global-sales-and-distribution) for access to the LVDS adapter. ### Known Issues - No Known Issues ### Development Tools - [MPLAB® X IDE v6.20](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - [MPLAB® Code Configurator (MCC) Plugin v5.4.1](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® Code Configurator (MCC) Core v5.6.1](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® XC32 C/C++ Compiler v4.35](https://www.microchip.com/mplab/compilers) ### Dependent Components * [GFX v3.14.0](https://github.com/Microchip-MPLAB-Harmony/gfx/releases/tag/v3.14.0) ## Release v3.0.0 ### New Features New features added in this release are as follows: - Added Legato Quickstart WVGA configuration for the [Raspberry Pi Touch Display](https://www.raspberrypi.com/products/raspberry-pi-touch-display/) MIPI DSI Display - Added Legato Quickstart WVGA configuration for the [AC69T88A LVDS WVGA Display](https://www.microchipdirect.com/dev-tools/AC69T88A?allDevTools=true) **Note:** Please contact your local [Microchip Sales Office](https://www.microchip.com/en-us/about/global-sales-and-distribution) for access to the LVDS adapter and LVDS display. - Added Legato Quickstart 1280x400 configuration for the [Waveshare 7.9inch DSI LCD](https://www.waveshare.com/7.9inch-dsi-lcd.htm) Display ### Known Issues - No Known Issues ### Development Tools - [MPLAB® X IDE v6.10](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - [MPLAB® Code Configurator (MCC) Plugin v5.3.7](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® Code Configurator (MCC) Core v5.5.7](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® XC32 C/C++ Compiler v4.30](https://www.microchip.com/mplab/compilers) ### Dependent Components * [GFX v3.13.0](https://github.com/Microchip-MPLAB-Harmony/gfx/releases/tag/v3.13.0) ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/release_notes.html",
    "relUrl": "/release_notes.html"
  },"9": {
    "doc": "Harmony 3 Graphics SAM 9x7 Applications Package",
    "title": "Harmony 3 Graphics SAM 9x7 Applications Package",
    "content": "# ![MPLAB® Harmony Graphics Suite](/gfx_apps_sam_9x7/images/mhgs.png) MPLAB® Harmony 3 Graphics Application Examples for SAM 9x7 Family MPLAB® Harmony Graphics Suite is an extension of the MPLAB® ecosystem for creating embedded graphics firmware solutions for Microchip 32-bit SAM and PIC microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB® X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) - [MPLAB® Discover](https://mplab-discover.microchip.com/v1/itemtype/com.microchip.ide.project?s0=Legato) This repository contains the MPLAB® Harmony 3 Graphics application examples for SAM 9x7 Family. Graphics applications are standalone applications which demonstrate of some of the capabilities of MPLAB® Harmony Graphics Suite. Refer to the following links for release notes, home page, training materials, framework and application help. For more information on the tools, libraries and basic development with the MPLAB® Harmony Graphics Suite, please see the gfx repo also on github. - [Release Notes](/gfx_apps_sam_9x7/release_notes.html) - [MPLAB® Harmony License](/gfx_apps_sam_9x7/mplab_harmony_license.html) - [MPLAB® Harmony 3 Graphics User Guides Wiki](https://github.com/mchpgfx/legato.docs/wiki) - [MPLAB® Harmony 3 Graphics API Help](https://mchpgfx.github.io/legato.docs/html/index.html) - [MPLAB® Harmony 3 Graphics Videos](https://www.youtube.com/playlist?list=PL9B4edd-p2ag5xsIIHhja-caKYY7AKPxe) - [MPLAB® Harmony 3 Graphics Suite Documentation](https://microchip-mplab-harmony.github.io/gfx/documentation.html) # Contents Summary | Folder | Description |------------|----------------------------------------------| apps | Example Graphics applications | docs | Contains files supporting documentation | Documentation is available for offline viewing. It can be used only after cloning this repository onto a local machine. For online viewing, please use [github pages](https://microchip-mplab-harmony.github.io/gfx_apps_sam_9x7/) of this repository. ## Graphics application examples (Legato) The following applications are provided to demonstrate a subset of the capabilities of Harmony Graphics Suite. | Category | Item | Description | Release Type | --- | --- | ---- |---- | apps | [legato_quickstart](/gfx_apps_sam_9x7/apps/legato_quickstart/readme.html) | Legato Graphics Library Quickstart Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | apps | [legato_adventure](/gfx_apps_sam_9x7/apps/legato_adventure/readme.html) | Legato Graphics Library Quickstart Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | apps | [legato_washing_machine](/gfx_apps_sam_9x7/apps/legato_washing_machine/readme.html) | Legato Graphics Library Quickstart Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | ## Graphics application examples (LVGL) The following applications are provided to demonstrate a subset of the capabilities of Harmony Graphics Suite. | Category | Item | Description | Release Type | --- | --- | ---- |---- | apps | [lvgl_showcase](/gfx_apps_sam_9x7/apps/lvgl_showcase/readme.html) | Legato Graphics Library Quickstart Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_sam_9x7/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/mchpgfx/legato.docs.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx/tree/v3.12.0) [![Latest release date](https://img.shields.io/github/release-date/mchpgfx/legato.docs.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx/tree/v3.12.0) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/gfx_apps_sam_9x7.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_sam_9x7/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/gfx_apps_sam_9x7.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() ",
    "url": "http://localhost:4000/gfx_apps_sam_9x7/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "gfx_apps_sam_9x7";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Graphics Applications SAM9x7 Family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/gfx_apps_sam_9x7/assets/css/just-the-docs-' + theme + '.css');
}
